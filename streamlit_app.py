...
if check_password():
    ...
    if uploaded_file is not None:
            ...
            if len(colonne) >= 2:
                ...
                # --- MODALITÀ 2: GRAFICO DOPPIO RAGGRUPPATO ---
                    ...
                    if col_valori:
                        ...
                        st.info("💡 Seleziona almeno una colonna nel menu multiselect a sinistra.")
            else:
        ...
        st.info("👋 Benvenuto! Trascina qui dentro il tuo file Excel (.xlsx) per vedere tabelle e grafici interattivi.")
